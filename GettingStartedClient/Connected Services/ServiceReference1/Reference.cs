...
namespace GettingStartedClient.ServiceReference1 {
    ...
    public interface ICalculator {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://Microsoft.ServiceModel.Samples/ICalculator/SomeTask", ReplyAction="http://Microsoft.ServiceModel.Samples/ICalculator/SomeTaskResponse")]
        string SomeTask();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://Microsoft.ServiceModel.Samples/ICalculator/SomeTask", ReplyAction="http://Microsoft.ServiceModel.Samples/ICalculator/SomeTaskResponse")]
        System.Threading.Tasks.Task<string> SomeTaskAsync();
    }
    ...
    public partial class CalculatorClient : System.ServiceModel.ClientBase<GettingStartedClient.ServiceReference1.ICalculator>, GettingStartedClient.ServiceReference1.ICalculator {
        ...
        public string SomeTask() {
            return base.Channel.SomeTask();
        }
        
        public System.Threading.Tasks.Task<string> SomeTaskAsync() {
            return base.Channel.SomeTaskAsync();
        }
    }
}
